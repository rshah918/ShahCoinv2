...
"""Verify that starting shahcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start shahcoin with -h for help text")
        ...
        self.log.info("Start shahcoin with -version for version information")
        ...
        self.log.info("Start shahcoind with -fakearg to make sure it does not start")
