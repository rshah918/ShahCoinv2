# Support for Output Descriptors in Shahcoin Core

Since Shahcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Shahcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Shahcoin Core wallets, a convenience function `combo` is
