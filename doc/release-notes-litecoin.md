Shahcoin Core version 0.18.1 is now available from:

  <https://download.shahcoin.org/shahcoin-0.18.1/>
...
`/Applications/Shahcoin-Qt` (on Mac) or `shahcoind`/`shahcoin-qt` (on
Linux).
...
- Four new options are available for configuring the maximum number of
  ...
  documentation](https://github.com/shahcoin-project/shahcoin/blob/master/doc/zmq.md#usage)
  for details.
...
- The `whitelistforcerelay` option is used to relay transactions from
  ...
  [contacting](mailto:contact@shahcoin.org) the Shahcoin Core
  project to let us know about their use-case, as this feature could be
  deprecated in the future).

Wallet changes
--------------
When creating a transaction with a fee above `-maxtxfee` (default 0.1 SHAH),
the RPC commands `walletcreatefundedpsbt` and  `fundrawtransaction` will now fail
instead of rounding down the fee. Beware that the `feeRate` argument is specified
in SHAH per kilobyte, not litoshi per byte.

Documentation
-------------

- A new short [document](https://github.com/shahcoin-project/shahcoin/blob/master/doc/JSON-RPC-interface.md)
  about the JSON-RPC interface describes cases where the results of an
  RPC might contain inconsistencies between data sourced from different
  subsystems, such as wallet state and mempool state.  A note is added
  to the [REST interface documentation](https://github.com/shahcoin-project/shahcoin/blob/master/doc/REST-interface.md)
  indicating that the same rules apply.

- Further information is added to the [JSON-RPC
  documentation](https://github.com/shahcoin-project/shahcoin/blob/master/doc/JSON-RPC-interface.md)
  about how to secure this interface.

- A new [document](https://github.com/shahcoin-project/shahcoin/blob/master/doc/shahcoin-conf.md)
...
- A new document introduces Shahcoin Core's BIP174 [Partially-Signed
  ...
  (PSBT)](https://github.com/shahcoin-project/shahcoin/blob/master/doc/psbt.md)
...
- The [output script
  descriptor](https://github.com/shahcoin-project/shahcoin/blob/master/doc/descriptors.md)
...
- The minimum required version of Qt (when building the GUI) has been
  ...
  system](https://github.com/shahcoin-project/shahcoin/blob/master/depends/README.md)
  provides 5.9.7)
...
- `deriveaddresses` returns one or more addresses corresponding to an
  [output descriptor](https://github.com/shahcoin-project/shahcoin/blob/master/doc/descriptors.md).
...
- `importmulti` now supports importing of addresses from descriptors. A
  ...
  [here](https://github.com/shahcoin-project/shahcoin/blob/master/doc/descriptors.md).
...
- The 'account' API is removed after being deprecated in v0.17.  The
  ...
  v0.17](https://github.com/shahcoin-project/shahcoin/blob/master/doc/release-notes/release-notes-0.17.0.md#label-and-account-apis-for-wallet)
...
- `generate` is deprecated and will be fully removed in a subsequent
  ...
  in this version, restart shahcoind with the `-deprecatedrpc=generate`
...
- A new `shahcoin-wallet` tool is now distributed alongside Shahcoin
...
- Since version 0.16.0, Shahcoin Core’s built-in wallet has defaulted to
  ...
  addresses in Shahcoin Core 0.20.
