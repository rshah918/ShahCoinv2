...
const char * const BITCOIN_CONF_FILENAME = "shahcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Shahcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Shahcoin";
#else
    // Unix
    return pathRet / ".shahcoin";
#endif
#endif
}
