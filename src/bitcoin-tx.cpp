...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " shahcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  shahcoin-tx [options] <hex-tx> [commands]  Update hex-encoded shahcoin transaction\n" +
            "or:     shahcoin-tx [options] -create [commands]   Create hex-encoded shahcoin transaction\n" +
            "\n";
