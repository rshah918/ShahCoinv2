...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.shahcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.shahcointools.com");
        vSeeds.emplace_back("dnsseed.shahcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.shahcointools.com");
        vSeeds.emplace_back("seed-b.shahcoin.loshan.co.uk");
